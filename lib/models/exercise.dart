class Exercise{
  ...
  Exercise({this.name, this.exercise1, this.exercise2, this.exercise3, this.exercise4, this.exercise5, this.exercise6, this.exercise7, this.exercise8, this.exercise9, this.exercise10});
}
